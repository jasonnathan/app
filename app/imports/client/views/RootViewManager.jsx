...
import { createApp, View, ViewManager } from '/imports/client/touchstonejs/lib';

import TouchstoneApp from '/imports/client/TouchstoneApp';
import LoginContainer from '/imports/client/views/root/LoginContainer';
import LoginFlowViewManager from '/imports/client/views/root/LoginFlowViewManager';
import AppContainer from '/imports/client/views/root/AppContainer';
import AboutModalViewManager from '/imports/client/views/root/AboutModalViewManager';
import PushNotificationContainer from '/imports/client/views/root/PushNotificationContainer';
            ...
            <div className={c(`app-wrapper device--${get(window, 'device.platform')}`)}>
                <div className="device-silhouette">
                    <ViewManager name="root" defaultView={this.defaultView}>
                        ...
                        <View name="push-notification" component={PushNotificationContainer} />
                    </ViewManager>
                </div>
            </div>
        );
